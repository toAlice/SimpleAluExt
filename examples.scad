...
translate([0, 0, -vchassie_len / 2 + sidelen / 2])
extrusion(sidelen = sidelen, height = vchassie_len, notch = notch,
                      border_thickness = border_thickness,
                      arm_thickness = arm_thickness,
                      center_diameter = center_diameter,
                      center_sidelen = center_sidelen,
...
translate([ 0, hchassie_len / 2 + sidelen / 2, 0])
rotate([90, 0, 0])
